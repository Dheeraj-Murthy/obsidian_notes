...
- [!Important] On bringing high power appliances near the circuit like a charging cable to a laptop the noise levels increased significantly. going as high as 200 points from 55.
- [!Important] if the neutral edge is not placed on a bony part away from the target muscle, we get a high level of noise and the captured data is inconsistant.
- 